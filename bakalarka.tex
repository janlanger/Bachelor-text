...
\begin{itemize}
\item Webový server s podporou PHP (doporučeným serverem, na kterým byla aplikace testována je Apache HTTPD 2.2 s PHP jako SAPI modulem).
...
Konfigurace aplikace je umístěna na místě standardním pro Nette aplikace - v souboru \textit{/app/config.ini}. Je velmi důležité, aby tento soubor zůstal nepřístupný pro přístup z webu, protože obsahuje citlivé informace. Z webu by mimochodem měl být přístupný pouze adresář \textit{/www/}.
