...
Tato práce se zabývá možností vzájemného sdílení dat mezi univerzitním systémem KOS a připravovanou novou verzí aplikace Studentova Berlička, které slouží pro podporu vedení cvičení. V této úvodní kapitole najdete nástin historického vývoje obou systémů.
...
Prvotní verze Studentovy berličky vznikla v rámci bakalářské práce Jiřího Hunky v roce 2007. Vznikl tak komplexní systém, který usnadnil cvičícím vedení agendy cvičení, a studentům poskytl možnost kdykoliv zjistit vlastní hodnocení. Nová verze tak umožňovala bodování docházky, evidenci bodů za aktivitu na každé hodině, samozřejmě evidenci testů a také hodnocení a odevzdávání semestrálních prací.
...
Rozhodl jsem se proto nejdříve zjistit, jak získávání dat řeší některé větší aplikace, a zda-li by se nedali nějakým způsobem využít pro Studentovu berličku.
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=13cm]{figures/import_setup.png}
...
Paměťová náročnost tohoto postupu závisí na množství záznamů, jejichž závislosti nejsou v momentě načtení splněny. Respektive, abych byl přesnější, protože operace, která kontroluje reference a vyprazdňuje frontu, je poměrně \uv{drahá} (časově a paměťově náročná), není spouštěna vždy při vložení nové entity, ale až po určitém množství záznamů ve frontě a při ukončení parsování dat jedné tabulky.

Při testování nepřesahovala alokované paměť hodnoty 100 MB a zároveň se mi tímto postupem podařilo dosáhnout u stávajícího rz.xml rychlosti kolem 30 000 vložených záznamů za minutu.

Schéma řešení fronty je zobrazeno na obrázku \ref{fig:queue}.

//TODO - class diagram fronty.
