...
Jak už jsem naznačil, aplikace využije jako zdroj dat soubor rz.xml. Tato kapitola obsahuje analýzu dat ze zdrojového souboru včetně popisu významu jednotlivých elementů, které se v něm vyskytují.
...
Schéma práce aplikace je znázorněno na obrázku \ref{fig:struktura}. Vstupní XML soubor je zpracován importérem do \uv{live} databáze. Po dokončení samotného importu je spuštěna druhá fáze - aktualizace, případně vytvoření, revizí. Nastavení jejich aktualizace a vytváření se provádá v administrační části, a po vytvoření a nadefinování procedur webové služby jsou data přístupná prostřednictvím samotné webové služby.
