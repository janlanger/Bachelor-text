...
Tato kapitola obsahuje analýzu zdrojových dat ze zdrojového souboru včetně popisu významu jednotlivých elementů, které se v něm vyskytují.
...
Požadavky na možnost verzování a definice schématu aktualizace dat vychází především ze zkušeností s provozem stávající verze Studentovy Berličky a problémů které jí pokusy o průběžný import dat v minulosti způsobily. Nemůžeme se totiž spolehnout na to, že data v rz.xml jsou stoprocentně konzistentní, nemůžeme se ani spolehnout že v rz.xml najdeme vždy všechna data, může se stít, že na pár dní z exportu vypadnou a zase se objeví.
...
\section{Testování v reálném provozu}
%*****************************************************************************
\chapter{*Závěr}
\section{Splnění cíle a zadání}
%*****************************************************************************
