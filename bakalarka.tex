...
\declaration{V~Praze dne 4.\,1.\,2011}
...
Na přiloženém CD najdete u aplikace v adresáři \textit{tests} jednotkové testy tříd modelové vrstvy a presenterů.

Tabulky \ref{tab:tab1} a \ref{tab:tab2} shrnují počet testů jednotlivých tříd, počet kontrolních testování výstupů a pokrytí kódu.
...
\item[VIC] - Výpočetní a Informační Centrum ČVUT
...
V této kapitole naleznete obsah CD přiloženého k této bakalářské práci.

\begin{itemize}
\item readme.txt - popis obsahu CD s dalšími informacemi
\item aplikace/ - zdrojové kódy aplikace v PHP
\begin{itemize}
\item schema.sql - SQL definice hlavní databáze aplikace
\end{itemize}
\item text/
\begin{itemize}
\item src/ - zdrojový text v LaTeXu, včetně obrázků a šablon
\item langeja1\_2011bach.pdf - text bakalářské práce ve formátu PDF
\end{itemize} 
\end{itemize}
